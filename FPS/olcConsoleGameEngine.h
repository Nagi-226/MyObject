...
public:
	...
	int ConstructConsole(int width, int height, int fontw, int fonth)
	{
		...
		// Ensure screen width and height are within the range of short
		if (m_nScreenWidth > 32767) m_nScreenWidth = 32767;
		if (m_nScreenHeight > 32767) m_nScreenHeight = 32767;
